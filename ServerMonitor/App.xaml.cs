...
using ServerMonitor.UserControls.Flyouts;
...
namespace ServerMonitor
{
    ...
    sealed partial class App : Application
    {
        ...
        {
            SettingsCommand cmd = new SettingsCommand("privacy", "Privacy Policy", (x) =>
            {
                ...
                settings.HeaderBrush = new SolidColorBrush(Colors.DarkBlue);
